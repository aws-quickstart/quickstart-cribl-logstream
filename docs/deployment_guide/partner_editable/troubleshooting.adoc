...
*A.* Refer to the `Cribl LogStream Web URL` output of the CloudFormation stack after deployment. To log in, use the LogStream instance AMI ID as the password.
